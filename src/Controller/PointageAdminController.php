...
final class PointageAdminController extends AbstractController
{
    ...
    {
        return $this->render('pointageadmin/index.html.twig', [
    ...
    public function new(Employe $employe, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pointageadmin/new.html.twig', [
            'pointage' => $pointage,
            'form' => $form,
        ]);
    }

    #[Route('/csv', name: 'csv_pointageadmin_all')]
    public function csv(Request $request, EntityManagerInterface $em): Response
    {
        ...
        if ($request->isMethod('POST') && $request->request->has('import')) {
            ...
            return $this->redirectToRoute('csv_pointageadmin_all');
        }
        ...
        return $this->render('pointageadmin/newCsv.html.twig', [
            'preview' => $preview,
            'errors' => $errors
        ]);
    }

    #[Route('/employe', name: 'app_showEmployeadmin_index', methods: ['GET'])]
    public function showEmp(EmployeRepository $employeRepository, PointageRepository $pointageRepository): Response
    {
        return $this->render('pointageadmin/showEmp.html.twig', [
            'employes' => $employeRepository->findAll(),
            'pointages' => $pointageRepository->findAll(),
        ]);
    }

    #[Route('/newPointageEmp', name: 'app_newPointageEmpadmin', methods: ['GET', 'POST'])]
    public function newPointageEmp(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pointageadmin/newPointageEmp.html.twig', [
            'pointage' => $pointage,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_pointageadmin_show', methods: ['GET'])]
    public function show(Pointage $pointage): Response
    {
        return $this->render('pointageadmin/show.html.twig', [
            'pointage' => $pointage,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_pointageadmin_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, Pointage $pointage, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('pointageadmin/edit.html.twig', [
            'pointage' => $pointage,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_pointageadmin_delete', methods: ['POST'])]
